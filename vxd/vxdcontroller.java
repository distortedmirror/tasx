...
public class vxdcontroller {
            ...
            if (nd instanceof Element) {
                ...
                if (elname.equals("Connection")) {
                    Runnable r = new Runnable() {
                        ...
                        public void setArgs(Element el) {
                            this.el = el;
                        }
                    ...
                    for (int l = 0; l < childEls.getLength(); ++l) {
                        ...
                        if (childNd instanceof Element) {
                            ...
                            try {
                                ...
                                r.getClass().getMethod("setArgs", args).invoke(r, prms);
                                SwingUtilities.invokeLater(r);
                            } catch (Exception grgdex) {
                                grgdex.printStackTrace();
                            }
                        }
                    }
                }
    ...
    public void addLoadedElementIcon(Element el, int x, int y) {
        ...
        try {
            ...
            if (vxd.DEBUG) rex.printStackTrace();
        }
    }
    ...
    public vxdJButton GetIconButton(String name) {
        ...
        try {
            ...
            if (vxd.DEBUG) ex.printStackTrace();
        }
    ...
    public void initTreeView() {
        ...
        tree = new JVXDTree();
	tree.setCellRenderer(new VXDTreeCellRenderer());
